...
class DequeImplementation:
  ...
  def remove_first(self): 
    ...
    afterFirst = first.get_next()
    self._header.set_next(afterFirst)
    afterFirst.set_prev(self._header)
    self._size -= 1
  ...
  def insert_last(self, element):
    if self.is_empty():
      raise DequeEmptyException("Deque is empty!")
    last = self._trailer.get_prev()
    e = Node(element, last, self._trailer)
    self._trailer.set_prev(e)
    last.set_next(e)
...
Traceback (most recent call last):
  File "/home/tletsch/HSLU/HS25/ADS_Uebungen_Python/Uebungen/uebung02/al/aufgabe02/dequeue_implementation.py", line 102, in <module>
    deque.remove_first()
  File "/home/tletsch/HSLU/HS25/ADS_Uebungen_Python/Uebungen/uebung02/al/aufgabe02/dequeue_implementation.py", line 41, in remove_first
    raise DequeEmptyException("Deque is empty!")
